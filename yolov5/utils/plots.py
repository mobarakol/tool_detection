...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, type_value=None, max_size=1920, max_subplots=16):
        ...
        if len(targets) > 0:
            ...
            for j, box in enumerate(boxes.T.tolist()):
                ...
                if labels or conf[j] > 0.25:  # 0.25 conf thresh
                    ...
                    # print(np.array(box).shape, type_value, label)
